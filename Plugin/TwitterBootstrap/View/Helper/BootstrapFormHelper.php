...
class BootstrapFormHelper extends FormHelper {
	...
	public function radio($fieldName, $radioOptions = array(), $options = array()) {
		$label_class = $this->_extractOption('label_class', $options);
		$label_class = !empty($label_class)?$label_class:'radio';
		unset($options['label_class']);
		$options['legend'] = false;
		$options['separator'] = "\n";
		$out = parent::radio($fieldName, $radioOptions, $options);
		$out = $this->_restructureLabel($out, array('class' => $label_class));
		return $out;
	}
